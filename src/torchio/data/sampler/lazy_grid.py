...
class Lazy_GridSampler(Lazy_PatchSampler):
    ...
    Args:
        subject: Instance of :class:`~torchio.data.Lazy_Subject`
    ...
    Example:
        ...
        >>> sampler = tio.Lazy_GridSampler(colin, patch_size=88)
    ...
    def _compute_locations(self, subject: Lazy_Subject):
